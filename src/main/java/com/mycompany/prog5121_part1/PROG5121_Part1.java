...
public class PROG5121_Part1 {
    ...
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "You may proceed to create a Username and a Password.", "Output", JOptionPane.PLAIN_MESSAGE);//If they select yes they may proceed with creating the username and the password
        ...
        JOptionPane.showMessageDialog(null, "Thank you for using my app.", "Output", JOptionPane.PLAIN_MESSAGE);//If they select no thank the user for using my app
